...
function AppContent() {
  ...
  const showHeader1 = ['/','/signup','/login','/forgot-password'].includes(location.pathname);
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/belly-talk" element={
            <BellyTalk />
        } />
        <Route path="/consultant-landing" element={
            <><ConsultantSidebar /><LandingPageConsultant /></>
        } />
        <Route path="/consultant-records" element={
            <ConsultantRecord />
        } />
        <Route path="/consultant-patientsinfo" element={
            <><ConsultantSidebar /><ConsultantPatientInfo /></>
        } />
        <Route path="/consultant-appointment" element={
            <><ConsultantSidebar /><AppointmentConsultant /></>
        } />
        <Route path="/savedarticle" element={<><LibrarySidebar /><SavedArticle /></>} />
        <Route path="/library" element={<><LibrarySidebar /><Library /></>} />
        <Route path="/duedate-calculator" element={<DateCalculator />} />
        <Route path="/library-item1" element={<><LibrarySidebar /><Library1 /></>} />
        <Route path="/library-item2" element={<><LibrarySidebar /><Library2 /></>} />
        <Route path="/library-item3" element={<><LibrarySidebar /><Library3 /></>} />
        <Route path="/library-item4" element={<><LibrarySidebar /><Library4 /></>} />
        <Route path="/library-item5" element={<><LibrarySidebar /><Library5 /></>} />
        <Route path="/library-item6" element={<><LibrarySidebar /><Library6 /></>} />
        <Route path="/library-item7" element={<><LibrarySidebar /><Library7 /></>} />
        <Route path="/library-item8" element={<><LibrarySidebar /><Library8 /></>} />
        <Route path="/library-item9" element={<><LibrarySidebar /><Library9 /></>} />
        <Route path="/library-item10" element={<><LibrarySidebar /><Library10 /></>} />
        <Route path="/library-item13" element={<><LibrarySidebar /><WeeklyPregnancy /></>} />
        <Route path="/assistant-landing" element={ <><AssistantSidebar /><LandingPageAssistant /></>} />
        <Route path="/library-assistant" element={ <><AssistantSidebar /><LibraryAssistant /></>} />
        <Route path="/assistant-notification" element={<NotificationAssistant />} />
        <Route path="/admin-profile" element={<PatientUserManagement />} />
        <Route path="/appointment-assistant" element={<><AssistantSidebar /><AppointmentAssistant /></>} />
