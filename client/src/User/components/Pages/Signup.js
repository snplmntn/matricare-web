...
export default function Signup() {
    ...
    const validateForm = () => {
        ...
        if (!fullName.trim() || !email.trim() || !username.trim() || !password.trim() || !confirmPassword.trim() || !phoneNumber.trim()) {
    ...
    const handleSignup = async (e) => {
        ...
        try {
          ...
          console.error('Signup error:', err.response ? err.response.data.msg : err.message);
          setError(err.response ? err.response.data.msg : 'Signup error. Please try again.');
         } finally {
        ...
        <div className="signup-outer-container signup-background" style={{
            ...
            <div className="signup-container">
                <form onSubmit={handleSignup}>
                    ...
                    <div className="SU-form-group">
                        <button type="submit" className="SU-button" disabled={loading}>SIGN UP</button>
                    </div>
                </form>
            </div>
        </div>
