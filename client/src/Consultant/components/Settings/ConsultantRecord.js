    ...
    <div className="consultrecords-container">
      {!authenticated ? (
        <div className="consultrecords-password-container">
          <div
            className="background-image-consultrecords"
            style={{ backgroundImage: `url('/img/bg6.jpg')` }}
          ></div>
          <div className="overlay"></div>
          <Link
            to="/consultant-landing"
            className="back-button-consultrecords1"
          >
            <IoChevronBackCircle />
          </Link>
          ...
          <form onSubmit={handleLogin} className="consultrecords-password-form">
            <div className="password-input-container">
              <input
                ...
                required
              />
              <button type="submit" className="consultrecords-button">
                Submit
              </button>
            </div>
          </form>
        ...
        <div className="consultrecords-main-content">
          <div className="consultrecords-nav">
            <img
              src="/img/logo3.png"
              alt="Logo"
              className="logo-image-consultrecords"
            />
          </div>
          <div className="consultrecords-content">
            <div
              className="consultrecords-header-container"
              style={{ backgroundImage: "url('img/bg5.jpg')" }}
            >
              <Link
                to="/consultant-landing"
                className="back-button-consultrecords"
              >
                <IoChevronBackCircle />
              </Link>
            ...
            <div className="consultrecords-button-container">
              <div className="consultrecords-button-box">
                ...
                >
                  ...
                  <span className="consultrecords-button-text">
                    Medical History
                  </span>
                </button>
              </div>
