...
import '../../styles/pages/consultantnotification.css'; // Import the CSS file
import { IoArrowBackSharp  } from 'react-icons/io5';
import { Link } from "react-router-dom";

function ConsultantNotifications({ userRole }) {
  ...
  return (
    <div className="PatientDashboard">
      <Link to="/consultant-landing" className="notif-back-button"><IoArrowBackSharp /></Link>
